...
if [ ! -f powersOfTau28_hez_final_12.ptau ]; then
  wget https://hermez.s3-eu-west-1.amazonaws.com/powersOfTau28_hez_final_12.ptau -O powersOfTau28_hez_final_12.ptau
fi
...
npx snarkjs groth16 setup artifacts/circuits/merkle_proof/merkle_proof.r1cs powersOfTau28_hez_final_12.ptau artifacts/circuits/merkle_proof/merkle_proof_0000.zkey
...
npx snarkjs groth16 setup artifacts/circuits/proof_aggregator/proof_aggregator.r1cs powersOfTau28_hez_final_12.ptau artifacts/circuits/proof_aggregator/proof_aggregator_0000.zkey
